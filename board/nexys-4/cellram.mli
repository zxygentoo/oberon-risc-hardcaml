(** [Cellram] — the Phase-7 PSRAM memory controller + CPU/video arbiter (synthesizable).
    ...
    system clock — the board ships read 6 / write 5 at 60 MHz, the read deliberately one
    over spec for I/O-timing headroom; see [create]). The full 16 MiB chip is addressed:
